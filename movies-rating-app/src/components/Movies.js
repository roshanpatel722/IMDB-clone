...
function Movies() {
    ...
    return <>
        <div className="mb-8 text-center">
            ...
            {
                // If the movies are zero in the beginning then show the loader otherwise show movies
                movies.length == 0 ?
                    ...
                    <div className="flex flex-wrap justify-center">
                        {
                            // It shows the poster of the Movies
                            movies.map((movie) => (
                                <div className={`
                                ...
                                >
                                    ...
                                    cursor-pointer
                                    '
                                                    onClick={() => add(movie)}  // this movies are comming from map function line no. 55
                                                >😍</div> : 
                                                <div className='absolute top-2 right-2
                                    p-2
                                    bg-gray-800
